    ...
    configFields: [
      {
        ...
        options: [
          ...
          { value: 'gl_revenue', label: 'GL Account Revenue (by department)' },
          { value: 'gl_expense', label: 'GL Account Expense (by department, e.g. salary)' },
        ],
      },
      ...
      { key: 'branch_id', label: 'Branch ID (optional)', placeholder: 'Leave blank to sync all branches', type: 'text', required: false },
      { key: 'gl_account_id', label: 'GL Account ID (required for "GL Account Revenue"/"GL Account Expense")', placeholder: 'e.g. 1877271000001490007', type: 'text', required: false },
    ],
  },
  {
    id: 'zoho_sheet',
